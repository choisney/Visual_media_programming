...
def main():
    ...
    while True:
        ...
        # fillpolygon(canvas,W_5,color) < I want to draw windmill with full color but this ran very slowly and make error

        theata=(theata+5)%360
        cv2.imshow("windmill",canvas)
