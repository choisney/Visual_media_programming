...
def main():
    ...
    while True:
        ...
        H_vn=T_ct@R_vn_1@T_vn_1@R_vn_2 
        Q_vn=(H_vn@vn_pts).T
        Q_vn=Q_vn.astype('int')
        drawPolygon(canvas,Q_vn,[50,160,160])
        ...
        drawPolygon(canvas,Q_er,[250,50,0])
        ...
        #rocket-tri
        t_pts=getRegularNGon(3)
        t_pts*=20
        t_pts=translate(3,t_pts)

        T_t_1=makeTmat(350,0)
        R_t_1=makeRmat(veta)
        T_t_2=makeTmat(0,35)
        T_t_3=makeTmat(-20,0)
        R_t_2=makeRmat(-30)
        H_t=T_ct@R_t_1@T_t_1@R_t_2@T_t_2@T_t_3

        Q_t=(H_t@t_pts).T
        Q_t=Q_t.astype('int')
        drawPolygon(canvas,Q_t,[100,50,200])
