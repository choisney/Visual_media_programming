...
pygame.mixer.music.load(os.path.join(assets_path, 'Bongo_Madness.mp3'))
pygame.mixer.music.play(-1)

sound = pygame.mixer.Sound(os.path.join(assets_path, 'eating.mp3'))
# 뱀 객체
class Snake(object):
    def __init__(self):
        self.create()
    ...
    def draw(self, screen):
        ...
        for i, p in enumerate(self.positions):
            if self.length<=7:
                ...
                color = (150 + red * i, 50 + green, 100 + blue * i)
            else:
                color = (200 + red * i, 100 + green, 100 + blue * i)
...
class Game(object):
    ...
    def run_logic(self):
        ...
        if self.snake.length<=7:
            ...
            self.speed = (20 + self.snake.length) / 3
        else:
