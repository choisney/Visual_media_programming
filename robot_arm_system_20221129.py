...
def main():
    ...
    while True:
        ...
        Q_2=Q_2.astype('int')
        drawPolygon(canvas,Q_2,[100,150,123])
        ...
        Q_3=Q_3.astype('int')
        drawPolygon(canvas,Q_3,[200,200,10])
        ...
        Q_4=Q_4.astype('int')
        drawPolygon(canvas,Q_4,[40,240,123])

        
        #fifth arm(rotate)
        R_5=makeRmat(alpha)
        r_5=makeRmat(-beta)
        H_5=H_4@R_4@T_2_1@T_2_2@r_5
        Q_5=(H_5@R_5@rec_pts).T
        Q_5=Q_5.astype('int')
        drawPolygon(canvas,Q_5,[200,40,200])
